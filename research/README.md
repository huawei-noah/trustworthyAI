...
- **CAMA**: Implementation for [CAMA: Enhancing Mathematical Reasoning in Large Language Models with Causal Knowledge](https://arxiv.org/abs/2508.02583), AAAI, 2026.
...
- **Causal Discovery with RL**: Code, dataset, and training logs of experiments for the paper [Causal discovery with reinforcement learning](https://openreview.net/forum?id=S1g2skStPB), ICLR, 2020 (oral).

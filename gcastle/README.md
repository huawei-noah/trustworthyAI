...
- tensorflow (1.15.0)
 ...
 Note that the tensorflow dependency will be removed soon (in the next version v1.0.3, 2021.12.15), we are efforts to rewrite some algorithms, such as MCSL, GOLEM, fully based on pytorch.
